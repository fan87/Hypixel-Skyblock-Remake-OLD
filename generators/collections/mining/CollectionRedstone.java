...
public class CollectionRedstone extends SBCollection {
    public CollectionRedstone() {
        super(SBItems.REDSTONE, new CollectionPattern(100, 250, 750, 1500, 3000, 5000, 10000, 25000, 50000, 200000, 400000, 600000, 800000, 1000000, 1200000, 1400000), 16, CollectionType.MINING);
    }
