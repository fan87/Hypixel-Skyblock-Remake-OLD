...
public class CollectionQuartz extends SBCollection {
    public CollectionQuartz() {
        super(ItemsVanilla.QUARTZ, new CollectionPattern(50, 100, 250, 1000, 2500, 5000, 10000, 25000, 50000), 9, CollectionType.MINING);
    }
