...
public class CollectionMutton extends SBCollection {
    public CollectionMutton() {
        super(ItemsVanilla.MUTTON, new CollectionPattern(50, 100, 250, 1000, 2500, 5000, 10000, 25000, 50000, 100000), 10, CollectionType.FARMING);
    }
