...
public class GuiSkillMenu extends Gui {

    private final SBSkill skill;
    private final SBPlayer player;
    private final int page;

    public GuiSkillMenu(SBSkill skill, SBPlayer player, int page) {
    ...
    public void init() {
        ...
        renderGoBackItems(new GuiSkillTypesMenu(player), player.getPlayer());
