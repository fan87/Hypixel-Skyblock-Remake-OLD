...
public class CollectionPork extends SBCollection {
    public CollectionPork() {
        super(ItemsVanilla.PORK, new CollectionPattern(50, 100, 250, 1000, 2500, 5000, 10000, 25000, 50000), 9, CollectionType.FARMING);
    }
