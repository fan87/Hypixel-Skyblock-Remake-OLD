...
public class CollectionBlazeRod extends SBCollection {
    public CollectionBlazeRod() {
        super(ItemsVanilla.BLAZE_ROD, new CollectionPattern(50, 100, 250, 1000, 2500, 5000, 10000, 25000, 50000), 9, CollectionType.COMBAT);
    }
