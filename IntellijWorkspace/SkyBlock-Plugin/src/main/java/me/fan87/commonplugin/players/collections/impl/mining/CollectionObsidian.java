...
public class CollectionObsidian extends SBCollection {
    public CollectionObsidian() {
        super(ItemsVanilla.OBSIDIAN, new CollectionPattern(50, 100, 250, 1000, 2500, 5000, 10000, 25000, 50000, 100000), 10, CollectionType.MINING);
    }
